...
public class OutilFichier {
	...
	private static final String PREFIXE_SAUVEGARDE = "sauvegardeOthello_";
	private static final String EXTENSION_SAUVEGARDE = ".othl";
	
    /**
	 * @return 		le prefixe de sauvegarde
	 */
	public static String getPrefixeSauvegarde() {
		return PREFIXE_SAUVEGARDE;
	}

	/**
	 * @return		l'extension des fichiers de sauvegarde
	 */
	public static String getExtensionSauvegarde() {
		return EXTENSION_SAUVEGARDE;
	}
	...
	public static String nouveauNomFichier() {
		...
		return PREFIXE_SAUVEGARDE + jour + "_" + mois + "_" + annee + "_"
				+ heure + "h" + minute + EXTENSION_SAUVEGARDE;
	}
